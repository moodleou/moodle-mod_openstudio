...
I need to create a content and upload a file
  ...
  Scenario: Preferences Feature in My Module:
    ...
    And the "sortby" select box should contain "Date ascending"
    And the "sortby" select box should contain "Date descending"
    And the "sortby" select box should contain "Username A-Z"
    And the "sortby" select box should contain "Username Z-A"
    ...
    And the "sortby" select box should contain "Date ascending"
    And the "sortby" select box should contain "Date descending"
    And the "sortby" select box should contain "Title A-Z"
    And the "sortby" select box should contain "Title Z-A"
    And I should see "Quick select"
    And the "quickselect" select box should contain "My posts with my comments"
    And the "quickselect" select box should contain "My posts with other users comments"
    And the "quickselect" select box should contain "Other users posts with my comments"
    And the "quickselect" select box should contain "Other users posts with feedback requests"
