    ...
    public static function export_folder_data(\stdClass $user, array $mappings) {
        ...
        foreach ($folders as $folder) {
            ...
            $resultfolder = (object) [
                    ...
                    'description' => format_text($folder->description, $folder->textformat, ['context' => $context]),
    ...
    public static function export_content_version(\stdClass $user, \context_module $context, ?\stdClass $content,
        ...
        foreach ($contentversions as $version) {
            ...
            $resultcontent[$version->contentversionid] = [
                    ...
                    'content' => format_text($version->content, $version->textformat, ['context' => $context]),
                    'description' => format_text($version->description, $version->textformat, ['context' => $context]),
                    'deletedtime' => $deletedtime,
                    'deletedby' => $deletedby,
