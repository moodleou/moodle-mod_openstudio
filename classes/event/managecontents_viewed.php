 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class managecontents_viewed extends \core\event\base {
    ...
    public function get_description() {
        $description = <<<EOF
The user with id '$this->userid' viewed manage content on course module id '$this->contextinstanceid'
EOF;
    ...
    public static function get_name() {
        return get_string('event:managecontentsviewed', 'mod_openstudio');
    }
