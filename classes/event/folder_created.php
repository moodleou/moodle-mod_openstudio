...
/**
 * The mod_openstudio folder created event.
 *
...
/**
 * The mod_openstudio folder created event class.
 *
 * @package    mod_openstudio
 * @since      Moodle 2.7
 * @copyright  2014 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class folder_created extends \core\event\base implements notifiable {
    ...
    public function get_description() {
        $description = <<<EOF
The user with id '$this->userid' created a set on course module id '$this->contextinstanceid'
EOF;
