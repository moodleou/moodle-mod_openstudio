...
/**
 * The mod_openstudio smile flag event event.
 *
...
/**
 * The mod_openstudio smile flag event class.
 *
 * @package    mod_openstudio
 * @since      Moodle 2.7
 * @copyright  2014 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class content_smile_flagged extends \core\event\base implements notifiable {
    ...
    public function get_description() {
        $description = <<<EOF
The user with id '$this->userid' flagged smiled on a content on course module id '$this->contextinstanceid'
EOF;
    ...
    public static function get_name() {
        return get_string('event:contentsmileflagged', 'mod_openstudio');
    }
