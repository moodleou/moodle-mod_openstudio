...
/**
 * The mod_openstudio scheduled unlock event.
 *
...
/**
 * The mod_openstudio scheduled unlock event class.
 *
 * @package    mod_openstudio
 * @since      Moodle 2.8
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class content_scheduled_unlocked extends \core\event\base {
...
EOF;
    ...
    public static function get_name() {
        return get_string('event:contentunlocked', 'mod_openstudio');
    }
