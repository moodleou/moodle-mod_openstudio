...
/**
 * The mod_openstudio folder inspire flag event.
 *
...
/**
 * The mod_openstudio folder inspire flag event class.
 *
 * @package    mod_openstudio
 * @since      Moodle 2.7
 * @copyright  2014 The Open University
...
class folder_inspire_flagged extends \core\event\base implements notifiable {
    ...
    public function get_description() {
        $description = <<<EOF
The user with id '$this->userid' flagged inspired on a set on course module id '$this->contextinstanceid'
EOF;
    ...
    public static function get_name() {
        return get_string('event:setinspireflagged', 'mod_openstudio');
    }
    ...
    public static function get_legacy_eventname() {
        return 'content inspire flagged (set)';
    }
