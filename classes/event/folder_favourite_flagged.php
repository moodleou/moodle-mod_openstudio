...
/**
 * The mod_openstudio folder favourited event.
 *
...
/**
 * The mod_openstudio folder favourited event class.
 *
 * @package    mod_openstudio
 * @since      Moodle 2.7
 * @copyright  2014 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class folder_favourite_flagged extends \core\event\base implements notifiable {
    ...
    public function get_description() {
        $description = <<<EOF
The user with id '$this->userid' flagged favourited on a set on course module id '$this->contextinstanceid'
EOF;
    ...
    public static function get_legacy_eventname() {
        return 'content favourite flagged (set)';
    }
