 ...
 */
function studio_api_rss_generate_key($userid, $feedtype) {
 ...
 */
function studio_api_rss_validate_key($key, $userid, $feedtype) {
    $correctkey = studio_api_rss_generate_key($userid, $feedtype);
    if ($correctkey == $key) {
        return true;
    } else {
        return false;
 ...
 * @return strng Return true if key is valid.
 */
function studio_api_rss_pinboard(
...
EOF;
    ...
    $params[] = $studioid;
    $params[] = $userid;
    $params[] = STUDIO_CONTENTTYPE_NONE;
 ...
 * @return strng Return true if key is valid.
 */
function studio_api_rss_activity(
        $userid, $studioid, $limitfrom = 0, $limitnum = 25, $time = '', array $flags = null) {
 ...
 * @return strng Return true if key is valid.
 */
function studio_api_rss_group(
        $userid, $studioid, $ownerid = '', array $tutorroles = array(), $limitfrom = 0, $limitnum = 25, $time = '', array $flags = null) {
...
EOF;
    ...
    $tutorpermissionsql = '';
    if (!empty($tutorroles)) {
        // The following is only applicable if STUDIO_VISIBILITY_TUTOR is enabled.
...
EOF;
        $tutorparams[] = STUDIO_VISIBILITY_TUTOR;
...
EOF;
    ...
    $params[] = $groupmode;
    $params[] = STUDIO_VISIBILITY_MODULE;
    $params[] = STUDIO_VISIBILITY_GROUP;
    $params[] = $groupmode;
    $params[] = STUDIO_VISIBILITY_MODULE;
    $params[] = STUDIO_VISIBILITY_GROUP;
    $params[] = $groupingid;
 ...
 * @return strng Return true if key is valid.
 */
function studio_api_rss_module(
 ...
 * @return strng Return true if key is valid.
 */
function studio_api_rss_slot($slotid, $limitfrom = 0, $limitnum = 25, $time = '', array $flags = null) {
    global $DB;
